...
@EnableJpaRepositories(
    basePackages = {"com.modyo.example.adapters.persistence"},
...
public class ModyoDbConfig {
  ...
  private static final String PERSISTENCE_ADAPTER_PACKAGE = "com.modyo.example.adapters.persistence";
